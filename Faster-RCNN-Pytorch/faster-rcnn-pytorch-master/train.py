...
if __name__ == "__main__":
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    model_path      = './faster-rcnn-pytorch-master/model_data/voc_weights_vgg.pth'
    #------------------------------------------------------#
    ...
    #   获得图片路径和标签
    #----------------------------------------------------#
    train_annotation_path   = '/data_lg/keru/project/Faster-RCNN-Pytorch/faster-rcnn-pytorch-master/map_out/2007_train.txt'
    val_annotation_path     = '/data_lg/keru/project/Faster-RCNN-Pytorch/faster-rcnn-pytorch-master/map_out/2007_val.txt'
